...
func AdminIndexChargeGet(c *gin.Context) {
	// get parameter
	...
	var response model.ResponseAdminIndexChargeGet
	response.Code = consts.SUCCESS
	response.Msg = "Get Charge id =" + charge_id + " success"
	response.Data = service.ChargeInformation(id)
